          ...
          {achievements.map((item, idx) => (
            ...
            >
              <div className="relative mb-8">
                <div className="absolute -inset-2 rounded-full border-3 border-dashed border-black " />
                ...
                <div className="relative flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border-4 border-black bg-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
                  <div className={`flex h-[85%] w-[85%] items-center justify-center rounded-full border-2 border-black ${item.bgColor}`}>
                    {item.icon}
                  </div>
                </div>
              </div>
